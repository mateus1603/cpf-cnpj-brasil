...
class CPFValidator:
    ...
    def _calcular_digito(self, cpf_parcial):
        ...
        Levanta ValueError se as entradas forem incompatíveis.
        """
...
class CNPJValidator:
    ...
    def formatar_cnpj(cnpj):
        ...
        Retorna:
        str: CNPJ formatado.
        Levanta ValueError se o CNPJ for inválido.
        """
    ...
    def investigar(self, cnpj: str, timeout: int = 10) -> Optional[Dict[str, Any]]:
        ...
        >>> dados = validator.investigar("00000000000191")
        >>> if dados:
        ...     print(dados['razao_social'])
        """
        # Validar formato do CNPJ
        cnpj_limpo = self._validar_formato_entrada(cnpj)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # CNPJ não encontrado
                print(
                    f"CNPJ {self.formatar_cnpj(cnpj_limpo)} não encontrado na base de dados.")
                return None
            ...
            print(
                f"Tempo limite excedido ao consultar o CNPJ {self.formatar_cnpj(cnpj_limpo)}.")
            return None
